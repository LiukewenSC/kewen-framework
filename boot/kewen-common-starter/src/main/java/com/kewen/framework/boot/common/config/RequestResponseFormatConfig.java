...
import com.kewen.framework.common.core.handler.ExceptionHandlerAdvice;
import com.kewen.framework.common.logger.context.TraceResponseBodyAdvice;
 ...
 */
@Configuration
public class RequestResponseFormatConfig {
     ...
     */
    @Bean
    ExceptionHandlerAdvice exceptionHandlerAdvance(){
        return new ExceptionHandlerAdvice();
    }
    @Bean
    TraceResponseBodyAdvice trackingLogResponseBodyAdvice(){
