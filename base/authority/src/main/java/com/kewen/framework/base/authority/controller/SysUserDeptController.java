...
public class SysUserDeptController {
    ...
    @GetMapping("/save")
    public Result save(@ModelAttribute SysUserDept entity){

        sysUserDeptService.saveOrUpdate(entity);
    ...
    public Result pageQuery(
            ...
            @ModelAttribute SysUserDept queryModel) {
        Page<SysUserDept> page = sysUserDeptService.pageQuery(pageNo, pageSize, queryModel);
        return Result.success(page);
    }

    @GetMapping(value = "/findList")
    public Result findList(@ModelAttribute SysUserDept queryModel) {

        List<SysUserDept> list = sysUserDeptService.findList(queryModel);
