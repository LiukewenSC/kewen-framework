...
public class DataCheckAspect {
    ...
    @Autowired
    private AuthHandler menuAuthComposite;



    @Pointcut("@annotation(com.kewen.framework.base.auth.annotation.CheckDataEdit)")
