package com.kewen.framework.base.auth.annotation.datarange;


import com.kewen.framework.base.auth.context.AuthUserContext;
import com.kewen.framework.base.auth.annotation.CheckDataRange;
...
public class DataRangeAspect {
    ...
    @Pointcut("@annotation(com.kewen.framework.base.auth.annotation.CheckDataRange)")
